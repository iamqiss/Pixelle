...
public abstract class DensityLogMessage extends ParameterizedMessage {
     ...
     */
    public DensityLogMessage(Map<String, Object> fields, String messagePattern, Object... args) {
    ...
    public static String asJsonArray(Stream<String> stream) {
        return "[" + stream.map(DensityLogMessage::inQuotes).collect(Collectors.joining(", ")) + "]";
    }
