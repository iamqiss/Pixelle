...
/**
 * Tests for DensityExecutors and its components like DensityAbortPolicy.
 */
public class DensityExecutorsTests extends DensityTestCase {
    ...
    public void testFixedForcedExecution() throws Exception {
        DensityThreadPoolExecutor executor = DensityExecutors.newFixed(
            getName(),
            1,
            1,
    ...
    public void testScaleUp() throws Exception {
        ...
        ThreadPoolExecutor pool = DensityExecutors.newScaling(
    ...
    public void testScaleDown() throws Exception {
        ...
        final ThreadPoolExecutor pool = DensityExecutors.newScaling(
            getClass().getName() + "/" + getTestName(),
            min,
            max,
            between(1, 100),
    ...
    public void testRejectionMessageAndShuttingDownFlag() throws InterruptedException {
        ...
        DensityThreadPoolExecutor executor = DensityExecutors.newFixed(
            ...
            pool,
            queue,
            DensityExecutors.daemonThreadFactory("dummy"),
            threadContext
        );
        try {
            ...
            try {
                ...
                assertThat(message, containsString("on DensityThreadPoolExecutor[name = " + getName()));
    ...
    public void testNodeProcessorsBound() {
        runProcessorsBoundTest(DensityExecutors.NODE_PROCESSORS_SETTING);
    }

    public void testProcessorsBound() {
        runProcessorsBoundTest(DensityExecutors.PROCESSORS_SETTING);
    }
