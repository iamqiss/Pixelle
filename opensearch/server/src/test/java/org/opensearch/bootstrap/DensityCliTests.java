...
public class DensityCliTests extends DensityCliTestCase {
    ...
    public void testDensitySettings() throws Exception {
    ...
    public void testDensitySettingCanNotBeEmpty() throws Exception {
        runTest(
            ExitCodes.USAGE,
            false,
