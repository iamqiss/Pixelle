...
public class RequestSamplerTests extends DensityTestCase {
    ...
    public void testShouldSampleForProbabilisticSampler() {
        clusterSettings.applySettings(
            Settings.builder()
                ...
                .put("telemetry.otel.tracer.span.sampler.classes", "org.density.telemetry.tracing.sampler.ProbabilisticSampler")
                .build()
        );
        ...
        clusterSettings.applySettings(
            Settings.builder()
                .put(
                    ...
                    "org.density.telemetry.tracing.sampler.ProbabilisticTransportActionSampler"
                )
                .build()
        );
