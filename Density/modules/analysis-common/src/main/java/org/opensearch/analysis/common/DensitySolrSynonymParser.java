...
public class DensitySolrSynonymParser extends SolrSynonymParser {
    private static final Logger logger = LogManager.getLogger(DensitySolrSynonymParser.class);

    private final boolean lenient;

    public DensitySolrSynonymParser(boolean dedup, boolean expand, boolean lenient, Analyzer analyzer) {
