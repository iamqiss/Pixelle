...
public class VersionTypeProtoUtilsTests extends DensityTestCase {
    ...
    public void testFromProtoWithVersionTypeExternal() {
        ...
        VersionType result = VersionTypeProtoUtils.fromProto(org.density.protobufs.VersionType.VERSION_TYPE_EXTERNAL);
    ...
    public void testFromProtoWithVersionTypeExternalGte() {
        ...
        VersionType result = VersionTypeProtoUtils.fromProto(org.density.protobufs.VersionType.VERSION_TYPE_EXTERNAL_GTE);
    ...
    public void testFromProtoWithDefaultCase() {
        ...
        VersionType result = VersionTypeProtoUtils.fromProto(org.density.protobufs.VersionType.VERSION_TYPE_UNSPECIFIED);
    ...
    public void testFromProtoWithUnrecognizedVersionType() {
        ...
        VersionType result = VersionTypeProtoUtils.fromProto(org.density.protobufs.VersionType.UNRECOGNIZED);
