...
use clap::ValueEnum;
use messenger_binary_protocol::cli::binary_client::get_clients::GetClientsOutput;
use messenger_binary_protocol::cli::binary_consumer_groups::get_consumer_groups::GetConsumerGroupsOutput;
use messenger_binary_protocol::cli::binary_context::get_contexts::GetContextsOutput;
use messenger_binary_protocol::cli::binary_personal_access_tokens::get_personal_access_tokens::GetPersonalAccessTokensOutput;
use messenger_binary_protocol::cli::binary_streams::get_streams::GetStreamsOutput;
use messenger_binary_protocol::cli::binary_system::stats::GetStatsOutput;
use messenger_binary_protocol::cli::binary_topics::get_topics::GetTopicsOutput;
use messenger_binary_protocol::cli::binary_users::get_users::GetUsersOutput;
