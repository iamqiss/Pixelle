...
export const getMessengerAddress = (host = '127.0.0.1', port = 8090): [string, number] => {
  if (process.env.MESSENGER_TCP_ADDRESS) {
    const s = (process.env.MESSENGER_TCP_ADDRESS || '').split(':');
