 ...
 *
 * This test fixture is meant for use in end-to-end (E2E) tests for the Messenger C++ client.
 * It will start up the latest Messenger server inside a Docker container, allow you to
