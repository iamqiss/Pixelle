...
package org.apache.messenger.client.blocking;

import org.apache.messenger.user.GlobalPermissions;
import org.apache.messenger.user.IdentityInfo;
...
public abstract class UsersClientBaseTest extends IntegrationTest {
    ...
    void shouldLogin() {
        // when
        var identityInfo = usersClient.login("messenger", "messenger");
    ...
    void shouldCreateAndDeleteUser() {
        ...
        assertThat(users).map(UserInfo::username).containsExactlyInAnyOrder("messenger", "test");
    ...
    void shouldChangePassword() {
        // given
        IdentityInfo identity = usersClient.login("messenger", "messenger");

        // when
        usersClient.changePassword(identity.userId(), "messenger", "new-pass");
        usersClient.logout();
        IdentityInfo newLogin = usersClient.login("messenger", "new-pass");
