...
public abstract class IntegrationTest {
    ...
    @Container
    protected final GenericContainer<?> messengerServer = new GenericContainer<>(DockerImageName.parse("apache/messenger:edge"))
            .withExposedPorts(HTTP_PORT, TCP_PORT);

    protected MessengerBaseClient client;
    ...
    abstract protected MessengerBaseClient getClient();
