...
using Apache.Messenger.Tests.Integrations.Attributes;
...
public class SystemTests
{
    ...
    public async Task GetStats_Should_ReturnValidResponse(Protocol protocol)
    {
        ...
        response.MessengerServerVersion.ShouldNotBeNullOrEmpty();
        response.MessengerServerSemver.ShouldNotBe(0u);
    }
