...
using Apache.Messenger.Tests.Integrations.Helpers;
using Shouldly;
...
public class StreamsTests
{
    ...
    [ClassDataSource<MessengerServerFixture>(Shared = SharedType.PerClass)]
    public required MessengerServerFixture Fixture { get; init; }
