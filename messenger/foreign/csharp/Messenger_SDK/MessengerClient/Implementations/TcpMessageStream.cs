...
using Apache.Messenger.ConnectionStream;
using Apache.Messenger.Contracts;
using Apache.Messenger.Contracts.Auth;
using Apache.Messenger.Contracts.Tcp;
using Apache.Messenger.Enums;
using Apache.Messenger.Exceptions;
using Apache.Messenger.Headers;
using Apache.Messenger.Kinds;
using Apache.Messenger.Mappers;
using Apache.Messenger.Messages;
using Apache.Messenger.MessagesDispatcher;
using Apache.Messenger.Utils;
using Microsoft.Extensions.Logging;

namespace Apache.Messenger.MessengerClient.Implementations;

public sealed class TcpMessageStream : IMessengerClient, IDisposable
{
