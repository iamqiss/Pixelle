...
using Apache.Messenger.JsonConverters;

namespace Apache.Messenger.Contracts;
...
public sealed class StatsResponse
{
    ...
    public required string MessengerServerVersion { get; init; }
    public uint MessengerServerSemver { get; init; }
