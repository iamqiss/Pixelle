...
using Apache.Messenger.MessengerClient.Implementations;
using Microsoft.Extensions.Logging;

namespace Apache.Messenger.Factory;
...
public static class MessageStreamFactory
{
    ...
    public static IMessengerClient CreateMessageStream(Action<IMessageStreamConfigurator> options,
