...
import org.density.cloud.azure.classic.AbstractAzureComputeServiceTestCase;
...
public class AzureTwoStartedNodesTests extends AbstractAzureComputeServiceTestCase {
    ...
    public void testTwoNodesShouldRunUsingPrivateOrPublicIp() {
        final String hostType = randomFrom(org.density.discovery.azure.classic.AzureSeedHostsProvider.HostType.values()).getType();
