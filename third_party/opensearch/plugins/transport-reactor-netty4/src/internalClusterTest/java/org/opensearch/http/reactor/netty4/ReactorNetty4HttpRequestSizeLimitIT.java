...
public class ReactorNetty4HttpRequestSizeLimitIT extends DensityReactorNetty4IntegTestCase {
    ...
    public void testLimitsInFlightRequests() throws Exception {
        ...
        try (ReactorHttpClient nettyHttpClient = ReactorHttpClient.create(false)) {
            ...
            try {
                ...
                final Collection<FullHttpResponse> multipleResponses = nettyHttpClient.post(transportAddress.address(), requests);
                try {
