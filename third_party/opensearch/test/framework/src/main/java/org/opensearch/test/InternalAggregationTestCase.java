...
import static org.density.search.aggregations.InternalMultiBucketAggregation.countInnerBucket;
...
public abstract class InternalAggregationTestCase<T extends InternalAggregation> extends AbstractNamedWriteableTestCase<T> {
    ...
    protected <P extends ParsedAggregation> P parseAndAssert(
        ...
        try (XContentParser parser = createParser(xContentType.xContent(), mutated)) {
            ...
            DensityAssertions.assertToXContentEquivalent(originalBytes, parsedBytes, xContentType);
