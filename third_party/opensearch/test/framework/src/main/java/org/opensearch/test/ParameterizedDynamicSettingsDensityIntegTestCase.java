 ...
 * settings will be applied dynamically, please notice that not all settings could be changed dynamically (consider using {@link ParameterizedStaticSettingsDensityIntegTestCase}
 * instead).
 * <p>
 ...
 * </ul>
 */
public abstract class ParameterizedDynamicSettingsDensityIntegTestCase extends ParameterizedDensityIntegTestCase {
    public ParameterizedDynamicSettingsDensityIntegTestCase(Settings dynamicSettings) {
