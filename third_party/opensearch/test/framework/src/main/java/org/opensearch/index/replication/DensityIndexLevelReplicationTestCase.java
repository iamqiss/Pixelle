...
import org.density.action.bulk.BulkShardResponse;
import org.density.action.bulk.MappingUpdatePerformer;
...
import org.density.action.support.replication.TransportWriteActionTestHelper;
...
public abstract class DensityIndexLevelReplicationTestCase extends IndexShardTestCase {
    ...
    protected class ReplicationGroup implements AutoCloseable, Iterable<IndexShard> {
        ...
        public void recoverReplica(
            ...
            DensityIndexLevelReplicationTestCase.this.recoverUnstartedReplica(
                replica,
                primary,
                targetSupplier,
                markAsRecovering,
            ...
            DensityIndexLevelReplicationTestCase.this.startReplicaAfterRecovery(replica, primary, inSyncIds, routingTable);
            computeReplicationTargets();
        }
    ...
    protected abstract class ReplicationAction<
        ...
        class PrimaryRef implements ReplicationOperation.Primary<Request, ReplicaRequest, PrimaryResult> {
            ...
            @Override
            public org.density.index.shard.ReplicationGroup getReplicationGroup() {
