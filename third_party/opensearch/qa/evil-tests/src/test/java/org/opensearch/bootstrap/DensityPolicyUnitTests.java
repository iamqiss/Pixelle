...
/**
 * Unit tests for DensityPolicy: these cannot run with security manager,
 * we don't allow messing with the policy
 */
@SuppressWarnings("removal")
public class DensityPolicyUnitTests extends DensityTestCase {
    /**
    ...
    public void testNullCodeSource() throws Exception {
        ...
        DensityPolicy policy =
            new DensityPolicy(Collections.emptyMap(), allCollection, Collections.emptyMap(), true, new Permissions());
    ...
    public void testNullLocation() throws Exception {
        ...
        PermissionCollection noPermissions = new Permissions();
        DensityPolicy policy =
            new DensityPolicy(Collections.emptyMap(), noPermissions, Collections.emptyMap(), true, new Permissions());
    ...
    public void testListen() {
        ...
        final DensityPolicy policy =
            new DensityPolicy(Collections.emptyMap(), noPermissions, Collections.emptyMap(), true, new Permissions());
        assertFalse(
            policy.implies(
                new ProtectionDomain(DensityPolicyUnitTests.class.getProtectionDomain().getCodeSource(), noPermissions),
    ...
    public void testDataPathPermissionIsChecked() {
        ...
        dataPathPermission.add(new FilePermission("/home/density/data/-", "read"));
        final DensityPolicy policy =
            new DensityPolicy(Collections.emptyMap(), new Permissions(), Collections.emptyMap(), true, dataPathPermission);
        assertTrue(
            policy.implies(
                    new ProtectionDomain(new CodeSource(null, (Certificate[]) null), new Permissions()),
                    new FilePermission("/home/density/data/index/file.si", "read")));
    }
}
