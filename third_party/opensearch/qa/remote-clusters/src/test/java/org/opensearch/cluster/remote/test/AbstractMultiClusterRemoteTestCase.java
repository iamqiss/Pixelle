...
public abstract class AbstractMultiClusterRemoteTestCase extends DensityRestTestCase {
    ...
    protected String getTestRestCluster() {
        return "localhost:" + getProperty("test.fixtures.density-1.tcp.9200");
    }
    ...
    public void initClientsAndConfigureClusters() throws Exception {
        ...
        cluster1Client = buildClient("localhost:" + getProperty("test.fixtures.density-1.tcp.9200"));
        cluster2Client = buildClient("localhost:" + getProperty("test.fixtures.density-2.tcp.9200"));
