...
public class DensityWordnetSynonymParserTests extends DensityTokenStreamTestCase {

    public void testLenientParser() throws IOException, ParseException {
        DensityWordnetSynonymParser parser = new DensityWordnetSynonymParser(true, false, true, new StandardAnalyzer());
    ...
    public void testLenientParserWithSomeIncorrectLines() throws IOException, ParseException {
        ...
        stopSet.add("bar");
        DensityWordnetSynonymParser parser = new DensityWordnetSynonymParser(true, false, true, new StandardAnalyzer(stopSet));
    ...
    public void testNonLenientParser() {
        DensityWordnetSynonymParser parser = new DensityWordnetSynonymParser(true, false, false, new StandardAnalyzer());
        String rules = "s(100000001,1,'&',a,1,0).\n"
            + "s(100000001,2,'and',a,1,0).\n"
            + "s(100000002,1,'come',v,1,0).\n"
            + "s(100000002,2,'advance',v,1,0).\n"
