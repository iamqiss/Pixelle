...
public class DensityGeoAssertions {
    ...
    public static void assertEquals(Object s1, Object s2) {
        if (s1 instanceof JtsGeometry && s2 instanceof JtsGeometry) {
            ...
            } else if (s1 instanceof org.density.geometry.Geometry && s2 instanceof org.density.geometry.Geometry) {
                Assert.assertEquals(s1, s2);
            } else {
    ...
    public static void assertMultiPolygon(Object shape, boolean useJTS) {
        if (useJTS) {
            ...
            assertTrue("expected Polygon[] but found " + shape.getClass().getName(), shape instanceof org.density.geometry.MultiPolygon);
        }
    }
    ...
    public static void assertPolygon(Object shape, boolean useJTS) {
        if (useJTS) {
            ...
            assertTrue("expected Polygon but found " + shape.getClass().getName(), shape instanceof org.density.geometry.Polygon);
        }
    }
