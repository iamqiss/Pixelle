...
public class RemoteClusterMetadataManifestTests extends DensityTestCase {
    ...
    public void testBlobPathTokens() {
        String uploadedFile = "user/local/density/manifest";
        RemoteClusterMetadataManifest remoteObjectForDownload = new RemoteClusterMetadataManifest(
            uploadedFile,
            clusterUUID,
            compressor,
        ...
        assertThat(remoteObjectForDownload.getBlobPathTokens(), is(new String[] { "user", "local", "density", "manifest" }));
    }
