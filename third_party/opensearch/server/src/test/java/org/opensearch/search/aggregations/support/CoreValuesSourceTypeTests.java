...
public class CoreValuesSourceTypeTests extends DensityTestCase {
    ...
    public void testFromString() {
        ...
        assertThat(
            e.getMessage(),
            equalTo("No enum constant org.density.search.aggregations.support.CoreValuesSourceType.DOES_NOT_EXIST")
        );
