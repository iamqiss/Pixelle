...
public class PathMatchDynamicTemplateTests extends DensitySingleNodeTestCase {
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/org/density/index/mapper/dynamictemplate/pathmatch/test-mapping.json");
        ...
        byte[] json = copyToBytesFromClasspath("/org/density/index/mapper/dynamictemplate/pathmatch/test-data.json");
