 ...
 * <h2> Key Classes </h2>
 *
 * <h3> {@link org.density.search.aggregations.support.ValuesSource} and its subclasses </h3>
 * <p>
 ...
 * such as {@link org.density.search.aggregations.support.ValuesSource.Numeric#isFloatingPoint()}.  Second level subclasses are
 * then specialized based on where they read values from, e.g. script or field cases.  There are also adapter classes like
 * org.density.search.aggregations.bucket.geogrid.CellIdSource which do run-time conversion from one type to another, often
 * dependent on a user specified parameter (precision in that case).
 * </p>
 *
 * <h3> {@link org.density.search.aggregations.support.ValuesSourceRegistry} </h3>
 * <p>
 ...
 * {@link org.density.search.SearchModule} is configuring aggregations.  It shouldn't be necessary to access the registry in most
 * cases, but you can get a read copy from {@link org.density.index.query.QueryShardContext#getValuesSourceRegistry()} if necessary.
 * </p>
 *
 * <h3> {@link org.density.search.aggregations.support.ValuesSourceType} </h3>
 * <p>
 ...
 * aggregations.  Fields which support aggregation set a ValuesSourceType on their {@link org.density.index.fielddata.IndexFieldData}
 * implementations, and aggregations register what types they support via one of the
 * {@link org.density.search.aggregations.support.ValuesSourceRegistry.Builder#register} methods.  The VaulesSourceType itself holds
 * information on how to with values of that type, including methods for creating
 * {@link org.density.search.aggregations.support.ValuesSource} instances and {@link org.density.search.DocValueFormat}
 * instances.
 * </p>
 *
 * <h3> {@link org.density.search.aggregations.support.ValuesSourceConfig} </h3>
 * <p>
 ...
 * different situations.  {@link org.density.search.aggregations.support.ValuesSourceAggregationBuilder#resolveConfig} has a good
 ...
 * <h3> {@link org.density.search.aggregations.support.ValueType} </h3>
 * <p>
