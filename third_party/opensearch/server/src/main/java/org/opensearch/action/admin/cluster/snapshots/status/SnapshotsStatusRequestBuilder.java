...
public class SnapshotsStatusRequestBuilder extends ClusterManagerNodeOperationRequestBuilder<
     ...
     */
    public SnapshotsStatusRequestBuilder(DensityClient client, SnapshotsStatusAction action) {
     ...
     */
    public SnapshotsStatusRequestBuilder(DensityClient client, SnapshotsStatusAction action, String repository) {
