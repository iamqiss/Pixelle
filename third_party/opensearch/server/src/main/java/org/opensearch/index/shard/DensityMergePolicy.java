 ...
 * @density.internal
 */
public final class DensityMergePolicy extends FilterMergePolicy {

    private static final Logger logger = LogManager.getLogger(DensityMergePolicy.class);
    ...
    public DensityMergePolicy(MergePolicy delegate) {
        super(delegate);
    }
