...
public class GetPipelineRequestBuilder extends ClusterManagerNodeReadOperationRequestBuilder<
    ...
    public GetPipelineRequestBuilder(DensityClient client, GetPipelineAction action) {
        super(client, action, new GetPipelineRequest());
    }

    public GetPipelineRequestBuilder(DensityClient client, GetPipelineAction action, String[] ids) {
