...
public class DensityRestTestCaseTests extends DensityTestCase {
    ...
    public void testIgnoreMatchMultipleTemplatesPattern() {
        ...
        Matcher matcher = DensityRestTestCase.CREATE_INDEX_MULTIPLE_MATCHING_TEMPLATES.matcher(input);
        ...
        matcher = DensityRestTestCase.PUT_TEMPLATE_MULTIPLE_MATCHING_TEMPLATES.matcher(input);
        assertThat(matcher.matches(), is(true));
