...
public abstract class DensityRestHighLevelClientTestCase extends DensityRestTestCase {
    ...
    protected static Map<String, Object> toMap(Response response) throws IOException, DensityParseException, ParseException {
