...
import org.density.threadpool.TaskAwareRunnable;
 ...
 * @density.internal
 */
public class DensityExecutors {

    private static final DeprecationLogger deprecationLogger = DeprecationLogger.getLogger(DensityExecutors.class);
     ...
     * available to Density (e.g., because of CPU limits).
     */
    ...
    public static PrioritizedDensityThreadPoolExecutor newSinglePrioritizing(
        String name,
        ThreadFactory threadFactory,
        ThreadContext contextHolder,
        ScheduledExecutorService timer
    ) {
        return new PrioritizedDensityThreadPoolExecutor(name, 1, 1, 0L, TimeUnit.MILLISECONDS, threadFactory, contextHolder, timer);
    }

    public static DensityThreadPoolExecutor newScaling(
        String name,
        int min,
        int max,
        long keepAliveTime,
        ...
        DensityThreadPoolExecutor executor = new DensityThreadPoolExecutor(
            name,
            min,
            max,
            keepAliveTime,
    ...
    public static DensityThreadPoolExecutor newFixed(
        String name,
        int size,
        int queueCapacity,
        ThreadFactory threadFactory,
        ...
        return new DensityThreadPoolExecutor(
            name,
            size,
            size,
            0,
    ...
    public static DensityThreadPoolExecutor newResizable(
        String name,
        int size,
        int queueCapacity,
        ThreadFactory threadFactory,
        ...
        return new QueueResizableDensityThreadPoolExecutor(
            name,
            size,
            size,
            0,
     ...
     */
    public static DensityThreadPoolExecutor newAutoQueueFixed(
        String name,
        int size,
        ...
        return new QueueResizingDensityThreadPoolExecutor(
            name,
            size,
            size,
            0,
    ...
    public static String threadName(final String nodeName, final String namePrefix) {
        ...
        return "density" + (nodeName.isEmpty() ? "" : "[") + nodeName + (nodeName.isEmpty() ? "" : "]") + "[" + namePrefix + "]";
    }
    ...
    public static ThreadFactory daemonThreadFactory(String namePrefix) {
        return new DensityThreadFactory(namePrefix);
    }
     ...
     * @density.internal
     */
    static class DensityThreadFactory implements ThreadFactory {
        ...
        DensityThreadFactory(String namePrefix) {
