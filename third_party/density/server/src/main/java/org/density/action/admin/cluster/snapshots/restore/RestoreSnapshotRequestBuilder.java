...
public class RestoreSnapshotRequestBuilder extends ClusterManagerNodeOperationRequestBuilder<
     ...
     */
    public RestoreSnapshotRequestBuilder(DensityClient client, RestoreSnapshotAction action) {
     ...
     */
    public RestoreSnapshotRequestBuilder(DensityClient client, RestoreSnapshotAction action, String repository, String name) {
