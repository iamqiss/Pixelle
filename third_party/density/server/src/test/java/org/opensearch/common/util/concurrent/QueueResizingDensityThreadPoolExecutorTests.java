...
/**
 * Tests for the automatic queue resizing of the {@code QueueResizingDensityThreadPoolExecutor}
 * based on the time taken for each event.
 */
public class QueueResizingDensityThreadPoolExecutorTests extends DensityTestCase {
    ...
    public void testExactWindowSizeAdjustment() throws Exception {
        ...
        QueueResizingDensityThreadPoolExecutor executor = new QueueResizingDensityThreadPoolExecutor(
            "test-threadpool",
            threads,
            threads,
            1000,
    ...
    private void executeTask(QueueResizingDensityThreadPoolExecutor executor, int times) {
