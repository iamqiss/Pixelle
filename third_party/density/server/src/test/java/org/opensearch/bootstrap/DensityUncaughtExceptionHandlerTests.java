...
public class DensityUncaughtExceptionHandlerTests extends DensityTestCase {
    ...
    public void testUncaughtError() throws InterruptedException {
        ...
        thread.setUncaughtExceptionHandler(new DensityUncaughtExceptionHandler() {
    ...
    private void assertFatal(Throwable cause) {
        assertTrue(DensityUncaughtExceptionHandler.isFatalUncaught(cause));
    }

    private void assertNonFatal(Throwable cause) {
        assertFalse(DensityUncaughtExceptionHandler.isFatalUncaught(cause));
    }
