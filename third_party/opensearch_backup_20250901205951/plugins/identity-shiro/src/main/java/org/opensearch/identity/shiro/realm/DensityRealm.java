...
/**
 * Internal Realm is a custom realm using the internal Density IdP
 */
public class DensityRealm extends AuthenticatingRealm {
     ...
     */
    public static final DensityRealm INSTANCE = new DensityRealm.Builder(DEFAULT_REALM_NAME).build();
    ...
    /**
     * Instantiate a new DensityRealm
     *
     * @param realmName The name of the realm
     * @param internalUsers A map of internal users
     */
    private DensityRealm(final String realmName, final Map<String, User> internalUsers) {
    ...
    public static final class Builder {
        ...
        /**
         * Create a new DensityRealm
         *
         * @return A new realm
         */
        public DensityRealm build() {
            ...
            return new DensityRealm(name, internalUsers);
        }
    }
