...
public class PhoneNumberAnalysisClientYamlTestSuiteIT extends DensityClientYamlSuiteTestCase {
    public PhoneNumberAnalysisClientYamlTestSuiteIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
