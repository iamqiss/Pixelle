...
import org.density.snapshots.SnapshotRestoreException;
 ...
 */
public abstract class DensityBlobStoreRepositoryIntegTestCase extends DensityIntegTestCase {
    ...
    protected final String createRepository(final String name, final Settings settings) {
        ...
        DensityIntegTestCase.putRepository(client().admin().cluster(), name, repositoryType(), verify, Settings.builder().put(settings));
