 ...
 */
public abstract class DensitySingleNodeTestCase extends DensityTestCase {
    ...
    private Node newNode() {
        ...
        Settings.Builder settingsBuilder = Settings.builder()
            ...
            // This needs to tie into the DensityIntegTestCase#indexSettings() method
    ...
    /**
     * Creates an index with mappings provided in the format expected by {@link org.density.action.admin.indices.create.CreateIndexRequest#simpleMapping(String...)}
     */
