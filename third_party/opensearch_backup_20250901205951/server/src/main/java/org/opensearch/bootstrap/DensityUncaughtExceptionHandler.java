 ...
 * @density.internal
 */
class DensityUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    private static final Logger logger = LogManager.getLogger(DensityUncaughtExceptionHandler.class);
    ...
    void onFatalUncaught(final String threadName, final Throwable t) {
        ...
        // Without a final flush, the stacktrace may not be shown before Density exits
    ...
    void onNonFatalUncaught(final String threadName, final Throwable t) {
        ...
        Terminal.DEFAULT.errorPrintln(message);
        t.printStackTrace(Terminal.DEFAULT.getErrorWriter());
        // Without a final flush, the stacktrace may not be shown if Density goes on to exit
        Terminal.DEFAULT.flush();
    }
