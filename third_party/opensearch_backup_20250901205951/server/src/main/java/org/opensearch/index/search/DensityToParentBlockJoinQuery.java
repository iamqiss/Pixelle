 ...
 * @density.internal
 */
public final class DensityToParentBlockJoinQuery extends Query {

    private final ToParentBlockJoinQuery query;
    private final String path;
    private final ScoreMode scoreMode;

    public DensityToParentBlockJoinQuery(Query childQuery, BitSetProducer parentsFilter, ScoreMode scoreMode, String path) {
        this(new ToParentBlockJoinQuery(childQuery, parentsFilter, scoreMode), path, scoreMode);
    }

    private DensityToParentBlockJoinQuery(ToParentBlockJoinQuery query, String path, ScoreMode scoreMode) {
        this.query = query;
        this.path = path;
    ...
    public Query rewrite(IndexSearcher searcher) throws IOException {
        ...
        if (innerRewrite != query) {
            ...
            if (innerRewrite instanceof ToParentBlockJoinQuery) {
                return new DensityToParentBlockJoinQuery((ToParentBlockJoinQuery) innerRewrite, path, scoreMode);
            } else {
                return innerRewrite;
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        DensityToParentBlockJoinQuery that = (DensityToParentBlockJoinQuery) obj;
