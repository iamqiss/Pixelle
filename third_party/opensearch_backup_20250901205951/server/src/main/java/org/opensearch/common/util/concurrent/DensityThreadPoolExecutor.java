 ...
 * @density.internal
 */
public class DensityThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        DensityExecutors.rethrowErrors(unwrap(r));
     ...
     * then this should return -1 which will prevent the value from showing up in {@link org.density.threadpool.ThreadPoolStats}.
     * ThreadPools that do support this metric should override this method. For example, {@link QueueResizingDensityThreadPoolExecutor}
