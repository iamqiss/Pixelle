 ...
 * @density.internal
 */
public final class DensityLeafReader extends SequentialStoredFieldsLeafReader {
     ...
     */
    public DensityLeafReader(LeafReader in, ShardId shardId) {
        super(in);
    ...
    public static DensityLeafReader getDensityLeafReader(LeafReader reader) {
        if (reader instanceof FilterLeafReader) {
            if (reader instanceof DensityLeafReader) {
                return (DensityLeafReader) reader;
            } else {
                ...
                return getDensityLeafReader(((FilterLeafReader) reader).getDelegate());
            }
        }
        return null;
    }
