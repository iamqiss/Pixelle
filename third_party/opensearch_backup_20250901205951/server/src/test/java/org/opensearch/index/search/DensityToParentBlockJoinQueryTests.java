...
public class DensityToParentBlockJoinQueryTests extends DensityTestCase {

    public void testEquals() {
        Query q1 = new DensityToParentBlockJoinQuery(
        ...
        Query q2 = new DensityToParentBlockJoinQuery(
            new TermQuery(new Term("is", "child")),
            new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
            ScoreMode.Avg,
            "nested"
        ...
        Query q3 = new DensityToParentBlockJoinQuery(
        ...
        Query q4 = new DensityToParentBlockJoinQuery(
            new TermQuery(new Term("is", "child")),
        ...
        Query q5 = new DensityToParentBlockJoinQuery(
            new TermQuery(new Term("is", "child")),
            new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
            ScoreMode.Total,
            "nested"
        ...
        Query q6 = new DensityToParentBlockJoinQuery(
            new TermQuery(new Term("is", "child")),
            new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
            ScoreMode.Avg,
            "nested2"
    ...
    public void testRewrite() throws IOException {
        Query q = new DensityToParentBlockJoinQuery(
            new PhraseQuery("body", "term"), // rewrites to a TermQuery
            new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
            ScoreMode.Avg,
            "nested"
        );
        Query expected = new DensityToParentBlockJoinQuery(
