...
public class ClusterBlockTests extends DensityTestCase {
    ...
    public void testGetIndexBlockWithId() {
        ...
        assertThat(builder.build().getIndexBlockWithId("index", randomValueOtherThan(blockId, DensityTestCase::randomInt)), nullValue());
    }
