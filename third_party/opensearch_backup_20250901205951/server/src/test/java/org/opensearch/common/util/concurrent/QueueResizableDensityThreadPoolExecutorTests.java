...
/**
 * Tests for the automatic queue resizing of the {@code QueueResizableDensityThreadPoolExecutor}
 * based on the time taken for each event.
 */
public class QueueResizableDensityThreadPoolExecutorTests extends DensityTestCase {
    private QueueResizableDensityThreadPoolExecutor executor;
    ...
    private void createExecutor(int queueSize, Function<Runnable, WrappedRunnable> runnableWrapper) {
        ...
        this.executor = new QueueResizableDensityThreadPoolExecutor(
            "test-threadpool",
            threads,
            threads,
            1000,
            ...
            queue,
            runnableWrapper,
            DensityExecutors.daemonThreadFactory("queuetest"),
    ...
    private void executeTask(QueueResizableDensityThreadPoolExecutor executor, int times) {
