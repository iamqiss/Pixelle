...
public class DefaultRestChannelTests extends DensityTestCase {
    ...
    public void testHeadersSet() {
        ...
        assertEquals(
            "Density/" + Build.CURRENT.getQualifiedVersion() + " (" + Build.CURRENT.getDistribution() + ")",
            headers.get("X-Density-Version").get(0)
        );
    }
    ...
    public void testReleaseInListener() throws IOException {
        ...
        // DensityTestCase#after will invoke ensureAllArraysAreReleased which will fail if the response content was not released
    }
