...
public class DensityWordnetSynonymParser extends WordnetSynonymParser {
    private static final Logger logger = LogManager.getLogger(DensityWordnetSynonymParser.class);

    private final boolean lenient;

    public DensityWordnetSynonymParser(boolean dedup, boolean expand, boolean lenient, Analyzer analyzer) {
