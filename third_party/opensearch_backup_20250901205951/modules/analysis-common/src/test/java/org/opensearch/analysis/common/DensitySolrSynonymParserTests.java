...
public class DensitySolrSynonymParserTests extends DensityTokenStreamTestCase {

    public void testLenientParser() throws IOException, ParseException {
        DensitySolrSynonymParser parser = new DensitySolrSynonymParser(true, false, true, new StandardAnalyzer());
    ...
    public void testLenientParserWithSomeIncorrectLines() throws IOException, ParseException {
        ...
        stopSet.add("bar");
        DensitySolrSynonymParser parser = new DensitySolrSynonymParser(true, false, true, new StandardAnalyzer(stopSet));
    ...
    public void testNonLenientParser() {
        DensitySolrSynonymParser parser = new DensitySolrSynonymParser(true, false, false, new StandardAnalyzer());
