...
package org.density.core.concurrency;
 ...
 * @density.internal
 */
public class DensityRejectedExecutionException extends RejectedExecutionException {

    private final boolean isExecutorShutdown;

    public DensityRejectedExecutionException(String message, boolean isExecutorShutdown) {
        super(message);
        this.isExecutorShutdown = isExecutorShutdown;
    }

    public DensityRejectedExecutionException(String message) {
        this(message, false);
    }

    public DensityRejectedExecutionException() {
        this(null, false);
    }
