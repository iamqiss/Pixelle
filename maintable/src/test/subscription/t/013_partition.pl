...
my $node_subscriber1 = maintableQL::Test::Cluster->new('subscriber1');
$node_subscriber1->init;
$node_subscriber1->start;

my $node_subscriber2 = maintableQL::Test::Cluster->new('subscriber2');
...
# publisher
$node_publisher->safe_psql('maintable', "CREATE PUBLICATION pub1");
...
# subscriber.
$node_subscriber1->safe_psql('maintable',
...
# the publisher.
$node_subscriber2->safe_psql('maintable',
...
# insert
$node_publisher->safe_psql('maintable', "INSERT INTO tab1 VALUES (1)");
$node_publisher->safe_psql('maintable', "INSERT INTO tab1_1 (a) VALUES (3)");
$node_publisher->safe_psql('maintable', "INSERT INTO tab1_2 VALUES (5)");
$node_publisher->safe_psql('maintable', "INSERT INTO tab1 VALUES (0)");

$node_publisher->wait_for_catchup('sub1');
$node_publisher->wait_for_catchup('sub2');

my $result = $node_subscriber1->safe_psql('maintable',
...
$result = $node_subscriber1->safe_psql('maintable',
...
$result = $node_subscriber2->safe_psql('maintable',
...
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 2 WHERE a = 1");
...
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 4 WHERE a = 6");
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 6 WHERE a = 4");
...
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 1 WHERE a = 0");
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 4 WHERE a = 1");
...
$node_publisher->safe_psql('maintable', "DELETE FROM tab1_2");

$node_publisher->wait_for_catchup('sub1');
$node_publisher->wait_for_catchup('sub2');

$result = $node_subscriber1->safe_psql('maintable', "SELECT a FROM tab1");
is($result, qq(), 'delete from tab1_1, tab1_2 replicated');

$result = $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab1_1");
is($result, qq(), 'delete from tab1_1 replicated');

$result = $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab1_2");
is($result, qq(), 'delete from tab1_2 replicated');

# truncate
$node_subscriber1->safe_psql('maintable',
	"INSERT INTO tab1 (a) VALUES (1), (2), (5)");
$node_subscriber2->safe_psql('maintable', "INSERT INTO tab1_2 (a) VALUES (2)");
$node_publisher->safe_psql('maintable', "TRUNCATE tab1_2");

$node_publisher->wait_for_catchup('sub1');
$node_publisher->wait_for_catchup('sub2');

$result =
  $node_subscriber1->safe_psql('maintable', "SELECT a FROM tab1 ORDER BY 1");
is( $result, qq(1
2), 'truncate of tab1_2 replicated');

$result =
  $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab1_2 ORDER BY 1");
is($result, qq(), 'truncate of tab1_2 replicated');

$node_publisher->safe_psql('maintable', "TRUNCATE tab1");
...
$result =
  $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab1 ORDER BY 1");
...
$node_subscriber1->safe_psql('maintable', "DELETE FROM tab1");
...
$node_publisher->safe_psql('maintable', "DELETE FROM tab1");
...
$node_publisher->safe_psql('maintable', "INSERT INTO tab2 VALUES (1)");
$node_publisher->safe_psql('maintable', "INSERT INTO tab4 VALUES (-1)");

# subscriber 1
$node_subscriber1->safe_psql('maintable', "DROP SUBSCRIPTION sub1");
$node_subscriber1->safe_psql('maintable',
...
# subscriber 2
$node_subscriber2->safe_psql('maintable', "DROP TABLE tab1");
$node_subscriber2->safe_psql('maintable',
...
$result = $node_subscriber1->safe_psql('maintable', "SELECT c, a FROM tab2");
is($result, qq(sub1_tab2|1), 'initial data synced for pub_viaroot');
$result =
  $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab4 ORDER BY 1");
is($result, qq(-1), 'initial data synced for pub_lower_level and pub_all');
$result =
  $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab4_1 ORDER BY 1");
is($result, qq(), 'initial data synced for pub_lower_level and pub_all');

# insert
$node_publisher->safe_psql('maintable', "INSERT INTO tab1 VALUES (1), (0)");
$node_publisher->safe_psql('maintable', "INSERT INTO tab1_1 (a) VALUES (3)");
$node_publisher->safe_psql('maintable', "INSERT INTO tab1_2 VALUES (5)");
$node_publisher->safe_psql('maintable',
...
$node_publisher->safe_psql('maintable', "INSERT INTO tab4 VALUES (0)");
...
# update (replicated as update)
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 6 WHERE a = 5");
$node_publisher->safe_psql('maintable', "UPDATE tab2 SET a = 6 WHERE a = 5");
$node_publisher->safe_psql('maintable', "UPDATE tab3 SET a = 6 WHERE a = 5");
...
# update (replicated as delete+insert)
$node_publisher->safe_psql('maintable', "UPDATE tab1 SET a = 2 WHERE a = 6");
$node_publisher->safe_psql('maintable', "UPDATE tab2 SET a = 2 WHERE a = 6");
$node_publisher->safe_psql('maintable', "UPDATE tab3 SET a = 2 WHERE a = 6");
...
# delete
$node_publisher->safe_psql('maintable', "DELETE FROM tab1");
$node_publisher->safe_psql('maintable', "DELETE FROM tab2");
$node_publisher->safe_psql('maintable', "DELETE FROM tab3");

$node_publisher->wait_for_catchup('sub_viaroot');
$node_publisher->wait_for_catchup('sub2');

$result = $node_subscriber1->safe_psql('maintable', "SELECT a FROM tab2");
is($result, qq(), 'delete tab2 replicated');

$result = $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab1");
is($result, qq(), 'delete from tab1 replicated');

$result = $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab2");
is($result, qq(), 'delete from tab2 replicated');

$result = $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab3");
...
$node_publisher->safe_psql('maintable', "TRUNCATE tab1_2, tab2_1, tab3_1");

$node_publisher->wait_for_catchup('sub_viaroot');
$node_publisher->wait_for_catchup('sub2');

$result =
  $node_subscriber1->safe_psql('maintable', "SELECT a FROM tab2 ORDER BY 1");
is( $result, qq(1
2
...
$result =
  $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab2 ORDER BY 1");
is( $result, qq(1
2
5), 'truncate of tab2_1 NOT replicated');

$node_publisher->safe_psql('maintable', "TRUNCATE tab1, tab2, tab3");
...
$result = $node_subscriber2->safe_psql('maintable', "SELECT a FROM tab3_1");
...
$node_subscriber1->safe_psql('maintable', "DELETE FROM tab2");
...
$node_publisher->safe_psql('maintable', "DELETE FROM tab2 WHERE a = 1");
...
$node_subscriber1->append_conf('maintableql.conf',
...
$node_publisher->safe_psql('maintable', "INSERT INTO tab5 VALUES (1, 1)");
$node_publisher->safe_psql('maintable', "UPDATE tab5 SET a = 2 WHERE a = 1");
...
$node_publisher->safe_psql('maintable', "UPDATE tab5 SET a = 3 WHERE a = 2");
...
$node_publisher->safe_psql('maintable', "UPDATE tab5 SET c = 1 WHERE a = 3");
...
$node_publisher->safe_psql('maintable', "UPDATE tab5 SET a = 4 WHERE a = 3");
