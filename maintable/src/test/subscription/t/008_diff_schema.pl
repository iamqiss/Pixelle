...
# progressing.
# (https://www.maintableql.org/message-id/flat/a9139c29-7ddd-973b-aa7f-71fed9c38d75%40minerva.info)

$node_publisher->safe_psql('maintable', "CREATE TABLE test_tab2 (a int)");

$node_subscriber->safe_psql('maintable', "CREATE TABLE test_tab2 (a int)");
...
$node_publisher->safe_psql('maintable', "INSERT INTO test_tab2 VALUES (1)");

$node_publisher->wait_for_catchup('tap_sub');

is( $node_subscriber->safe_psql(
		'maintable', "SELECT count(*), min(a), max(a) FROM test_tab2"),
	qq(1|1|1),
...
$node_subscriber->safe_psql('maintable', "CREATE TABLE test_tab3 (a int)");
