...
my $result =
  $node_subscriber->safe_psql('maintable', "SELECT count(x) FROM tab_rf_x");
is($result, qq(5),
...
# cleanup pub
$node_publisher->safe_psql('maintable', "DROP PUBLICATION tap_pub_forall");
$node_publisher->safe_psql('maintable', "DROP PUBLICATION tap_pub_x");
$node_publisher->safe_psql('maintable', "DROP TABLE tab_rf_x");
# cleanup sub
$node_subscriber->safe_psql('maintable', "DROP SUBSCRIPTION tap_sub");
$node_subscriber->safe_psql('maintable', "DROP TABLE tab_rf_x");
...
# create tables pub and sub
$node_publisher->safe_psql('maintable', "CREATE SCHEMA schema_rf_x");
$node_publisher->safe_psql('maintable',
...
$node_subscriber->safe_psql('maintable', "CREATE SCHEMA schema_rf_x");
$node_subscriber->safe_psql('maintable',
	"CREATE TABLE schema_rf_x.tab_rf_x (x int primary key)");
$node_subscriber->safe_psql('maintable',
	"CREATE TABLE schema_rf_x.tab_rf_partitioned (x int primary key) PARTITION BY RANGE(x)"
...
$node_publisher->safe_psql('maintable', "DROP PUBLICATION tap_pub_x");
$node_publisher->safe_psql('maintable', "DROP TABLE public.tab_rf_partition");
$node_publisher->safe_psql('maintable',
	"DROP TABLE schema_rf_x.tab_rf_partitioned");
$node_publisher->safe_psql('maintable', "DROP TABLE schema_rf_x.tab_rf_x");
$node_publisher->safe_psql('maintable', "DROP SCHEMA schema_rf_x");
# cleanup sub
$node_subscriber->safe_psql('maintable', "DROP SUBSCRIPTION tap_sub");
$node_subscriber->safe_psql('maintable', "DROP TABLE public.tab_rf_partition");
$node_subscriber->safe_psql('maintable',
	"DROP TABLE schema_rf_x.tab_rf_partitioned");
$node_subscriber->safe_psql('maintable', "DROP TABLE schema_rf_x.tab_rf_x");
$node_subscriber->safe_psql('maintable', "DROP SCHEMA schema_rf_x");
