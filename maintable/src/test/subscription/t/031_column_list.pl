...
$result =
  $node_subscriber->safe_psql('maintable', "SELECT * FROM tab1 ORDER BY a");
is( $result, qq(1|2|
...
$result =
  $node_subscriber->safe_psql('maintable', "SELECT * FROM tab4 ORDER BY a");
...
$result =
  $node_subscriber->safe_psql('maintable', qq(SELECT * FROM tab1 ORDER BY a));
is( $result,
	qq(1|4|
2|3|
4|5|
...
$result =
  $node_subscriber->safe_psql('maintable', qq(SELECT * FROM tab4 ORDER BY a));
...
$result =
  $node_subscriber->safe_psql('maintable', "SELECT * FROM tab2 ORDER BY a");
is( $result, qq(1|abc
...
is( $node_subscriber->safe_psql('maintable', "SELECT * FROM tab5 ORDER BY a"),
	qq(1|11|
2|22|
3|33|
4|44|),
...
is( $node_subscriber->safe_psql('maintable', "SELECT * FROM tab6 ORDER BY a"),
	qq(1|44||
...
is( $node_subscriber->safe_psql('maintable', "SELECT * FROM tab7 ORDER BY a"),
	qq(1|44||
2|66||), 'replication with the original primary key');
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT a, b FROM test_part_a ORDER BY a, b"),
	qq(1|3
2|5
6|4
7|6),
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT * FROM test_part_b ORDER BY a, b"),
	qq(1|1
2|3
6|2
7|4),
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT * FROM test_part_c ORDER BY a, b"),
	qq(1||5
2|4|
3||8
4|9|),
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT * FROM test_part_d ORDER BY a, b"),
	qq(1|
3|),
	'partitions with different replica identities not replicated correctly');
...
is( $node_subscriber->safe_psql('maintable', "SELECT * FROM test_mix_2"),
	qq(1|2|3
4|5|6),
...
is( $node_subscriber->safe_psql('maintable', "SELECT * FROM test_mix_3"),
	qq(1|2|3
4|5|6),
	'all columns should be replicated');
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT * FROM test_root ORDER BY a, b, c"),
	qq(1||
2||
10||
11||),
...
is( $node_subscriber->safe_psql('maintable', "SELECT * FROM s1.t ORDER BY a"),
	qq(1|2|3
4|5|6),
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT * FROM t ORDER BY a, b, c"),
	qq(1||
4||),
...
is( $node_subscriber->safe_psql(
		'maintable', "SELECT * FROM test_mix_4 ORDER BY a"),
	qq(1|2||),
