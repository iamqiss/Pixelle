...
# cleanup pub
$node_publisher->safe_psql('maintable', "DROP PUBLICATION tap_pub_rep_full");
$node_publisher->safe_psql('maintable', "DROP TABLE test_replica_id_full");
# cleanup sub
$node_subscriber->safe_psql('maintable', "DROP SUBSCRIPTION tap_sub_rep_full");
$node_subscriber->safe_psql('maintable', "DROP TABLE test_replica_id_full");
...
# cleanup pub
$node_publisher->safe_psql('maintable', "DROP PUBLICATION tap_pub_rep_full");
$node_publisher->safe_psql('maintable', "DROP TABLE users_table_part");

# cleanup sub
$node_subscriber->safe_psql('maintable', "DROP SUBSCRIPTION tap_sub_rep_full");
$node_subscriber->safe_psql('maintable', "DROP TABLE users_table_part");
...
# make sure that the subscriber has the correct data
$result =
  $node_subscriber->safe_psql('maintable', "SELECT count(*) FROM people");
is($result, qq(199),
	'ensure subscriber has the correct data at the end of the test');

# cleanup pub
$node_publisher->safe_psql('maintable', "DROP PUBLICATION tap_pub_rep_full");
$node_publisher->safe_psql('maintable', "DROP TABLE people");
# cleanup sub
$node_subscriber->safe_psql('maintable', "DROP SUBSCRIPTION tap_sub_rep_full");
$node_subscriber->safe_psql('maintable', "DROP TABLE people");
...
$node_subscriber->safe_psql('maintable', "DROP INDEX people_names");
