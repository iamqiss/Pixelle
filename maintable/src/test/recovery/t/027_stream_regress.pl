...
$node_primary->adjust_conf('maintableql.conf', 'max_connections', '25');
$node_primary->append_conf('maintableql.conf',
...
$node_primary->append_conf('maintableql.conf', 'synchronize_seqscans = off');
...
$node_primary->append_conf('maintableql.conf', 'autovacuum = off');
...
$node_primary->safe_psql('maintable', 'CREATE EXTENSION pg_stat_statements');
