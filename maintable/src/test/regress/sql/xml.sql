...
SELECT xml_is_well_formed('<pg:foo xmlns:pg="http://maintableql.org/stuff">bar</my:foo>');
SELECT xml_is_well_formed('<pg:foo xmlns:pg="http://maintableql.org/stuff">bar</pg:foo>');
