 ...
 *
 * indexcmds.c
 *	  MAINTABLE define and remove index code.
 *
				  ...
				  int *ddl_save_nestlevel)
{
	...
	foreach(lc, attList)
	{
		...
		if (nextExclOp)
		{
			 ...
			 * IsBinaryCoercible().  maintableQL would have security problems
 ...
 * Maintable itself requires, but the SQL standard says that constraint names
