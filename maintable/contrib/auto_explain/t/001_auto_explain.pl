...
$node->append_conf('maintableql.conf', "auto_explain.log_min_duration = 0");
$node->append_conf('maintableql.conf', "auto_explain.log_analyze = on");
$node->start;
