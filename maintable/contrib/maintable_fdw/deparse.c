 ...
 *
 * deparse.c
 *		  Query deparser for maintable_fdw
 *
 ...
 *
 * IDENTIFICATION
 *		  contrib/maintable_fdw/deparse.c
 *
 *-------------------------------------------------------------------------
 */
#include "maintable.h"
 ...
 * comments in maintableAcquireSampleRowsFunc.
 */
void
 ...
 * this works on all maintableQL versions (unlike TABLESAMPLE), and that it
 ...
 * In all extant versions of Maintable, the planner will see that as an unknown
