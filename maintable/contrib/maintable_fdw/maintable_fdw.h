 ...
 *
 * IDENTIFICATION
 *		  contrib/maintable_fdw/maintable_fdw.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef MAINTABLE_FDW_H
#define MAINTABLE_FDW_H
 ...
 * maintable_fdw foreign table.  For a baserel, this struct is created by
 * maintableGetForeignRelSize, although some fields are not filled till later.
 * maintableGetForeignJoinPaths creates it for a joinrel, and
 * maintableGetForeignUpperPaths creates it for an upperrel.
 */
